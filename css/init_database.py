...
# 插入菜单初始数据
menu_data = [
    (1, '宫保鸡丁', 18, 4.8, 128, '川菜'),
    (2, '鱼香肉丝', 16, 4.6, 96, '川菜'),
    (3, '麻辣香锅', 22, 4.9, 156, '火锅'),
    (4, '番茄炒蛋', 12, 4.5, 89, '快餐'),
    (5, '红烧肉', 28, 4.7, 72, '快餐'),
    (6, '清蒸鲈鱼', 38, 4.8, 45, '粤菜'),
    (7, '蒜蓉西兰花', 10, 4.4, 67, '健康'),
    (8, '酸辣土豆丝', 8, 4.3, 112, '川菜'),
    (9, '牛肉面', 15, 4.7, 134, '面食'),
    (10, '炸酱面', 12, 4.5, 108, '面食'),
    (11, '兰州拉面', 14, 4.6, 95, '面食'),
    (12, '麻辣烫', 20, 4.8, 167, '火锅'),
    (13, '凉拌鸡丝', 14, 4.4, 78, '健康'),
    (14, '白切鸡', 32, 4.9, 56, '粤菜'),
    (15, '烧鸭饭', 25, 4.6, 89, '粤菜'),
    (16, '孜然羊肉', 30, 4.7, 67, '清真'),
    (17, '大盘鸡', 35, 4.8, 78, '清真'),
    (18, '手抓饭', 22, 4.5, 82, '清真'),
    (19, '凉拌黄瓜', 8, 4.2, 56, '健康'),
    (20, '炒时蔬', 10, 4.3, 65, '快餐')
